...
data <- read.csv("PCA_data_GAM.csv", stringsAsFactors = FALSE)
...
saveRDS(model_gam, "output/gam_model_PCA.rds")

saveRDS(train_data, "output/train_data_gam_PCA.rds")
saveRDS(test_data, "output/test_data_gam_PCA.rds")
